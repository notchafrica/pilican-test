<div class="p-4">
    <div class="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        <div class="shadow rounded-lg w-full p-4 bg-white dark:bg-gray-800">
            ...
            <div class="flex flex-col justify-start">
                <p class="text-gray-800 text-md text-left dark:text-white font-bold my-4">
                    {{$company->orders()->whereStatus('complete')->whereMethod('cash')->sum('amount') -
        ...
        <div class="shadow rounded-lg w-full p-4 bg-white dark:bg-gray-800">
            <div class="flex items-center">
                <span class="bg-yellow-500 p-2 h-4 w-4 rounded-full relative">
                    <svg width="20" fill="currentColor" height="20"
                        class="text-white h-2 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"
                        viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                        <path
        ...
        <div class="shadow rounded-lg w-full p-4 bg-white dark:bg-gray-800">
            <div class="flex items-center">
                <span class="bg-red-500 p-2 h-4 w-4 rounded-full relative">
                    <svg width="20" fill="currentColor" height="20"
                        class="text-white h-2 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"
                        viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                        <path
            ...
            <div class="flex flex-col justify-start">
                ...
                <div class="relative w-28 h-2 bg-gray-200 rounded">
                    <div class="absolute top-0 h-2  left-0 rounded bg-red-500 w-0">
                    </div>
                </div>
            </div>
        </div>
        @endrole()
        @role("admin|sale|super-admin|warehouse")
        <div class="shadow rounded-lg w-full p-4 bg-white dark:bg-gray-800">
            <div class="flex items-center">
                <span class="bg-red-500 p-2 h-4 w-4 rounded-full relative">
                    <svg width="20" fill="currentColor" height="20"
        ...
        @endrole()
        @role("admin|warehouse|super-admin|sale")
        <div class="shadow rounded-lg w-full p-4 bg-white dark:bg-gray-800">
            <div class="flex items-center">
                <span class="bg-red-500 p-2 h-4 w-4 rounded-full relative">
                    <svg width="20" fill="currentColor" height="20"
    ...
    <div class="h-72 mt-5 shadow bg-white pt-5">
        <livewire:livewire-line-chart :line-chart-model="$salesChart" />
    </div>
    @endrole()
    @role("admin|super-admin|invoice")
    <div class="h-72 mt-5 shadow bg-white pt-5">
        <livewire:livewire-line-chart :line-chart-model="$cashoutsChart" />
    </div>
    @endrole()
    @role("admin|super-admin|warehouse")
    <div class="h-72 mt-5 shadow bg-white pt-5">
