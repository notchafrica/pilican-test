        ...
        <div class="px-2 w-full mt-4 space-y-2">
            ...
            <ul class="flex flex-col space-y-2 mt-2">
                {{-- <li><button
                        ...
                        class="flex px-3 py-2 transition-all delay-100 items-center space-x-2 ease-in-out hover:bg-green-100 w-full text-green-600 rounded-md">
    ...
    <div class="flex-grow overflow-y-auto px-4 pt-4 space-y-2">
        ...
        <div class="flex flex-col space-y-2 bg-white px-3 py-1.5 rounded-md border">
            <div class="flex items-center justify-between">
                <div
                    class="flex items-center @if($transaction->type == 'credit') text-green-600 @else text-red-600 @endif">
